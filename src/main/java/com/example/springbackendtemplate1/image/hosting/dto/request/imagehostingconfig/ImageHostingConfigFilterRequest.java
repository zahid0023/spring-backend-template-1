...
public class ImageHostingConfigFilterRequest extends PaginatedRequest implements Filterable {
    private String name;
    ...
    public List<Predicate> toPredicates(Root<?> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        for (ImageHostingConfigSearchField field : ImageHostingConfigSearchField.values()) {
